...
def process_chapter_for_save(chapter_scrape_result):
    ...
    return chapter_text, chapter_html

def save_chapter_text_html(chapter_text, chapter_html, narou_uid, chapter_text_datastore = 'datastore/chapter_raws_txt'):
...
for chapter in chapter_scrape_results[130:]:
