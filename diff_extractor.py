...
def get_file_versions_with_gitpython(repo_path, file_path, commit_hash="HEAD"):
    """
...
if __name__ == "__main__":
    ...
    string1, string2 = get_file_versions_with_gitpython(repo_path=path, file_path=filename)
    print(get_string_diff(string1, string2))
...
　次の瞬間にナツキ・スバルは命を落とした。
    ...
    string2 = '''
   第四章５１　『らぶらぶらぶらぶらぶらぶらぶらぶらぶらぶらぶらぶらぶらぶみー』
